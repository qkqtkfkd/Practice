// consol.log():개발자 도구에서 값을 확인할때 사용한다.
// 숫자, 변수, 문자 등등 많은 것을 넣어서 확인할 수 있다.

/* 주석을 여러 줄로 넣을 때는 이런 방식으로 넣어 주면 된다.*/
...
//변수 이름에 숫자를 슬수 있다. 하지만, 앞에 가장 먼저 나오면 안된다.
//let 1dog; 
...
//snake case:밑줄(underscore)를 활용한 변수명을 짓는 방법
